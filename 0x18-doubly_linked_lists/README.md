...
Directory: 0x18-doubly_linked_lists
...
lisa@ubuntu:~/0x17. Doubly linked lists$ gcc -Wall -pedantic -Werror -Wextra 9-main.c 9-print_dlistint_backward.c -o l
lisa@ubuntu:~/0x17. Doubly linked lists$ ./l
8
9
-> 2 elements
lisa@ubuntu:~/0x17. Doubly linked lists$ 
Repo:
